...
var Agent = /*#__PURE__*/_createClass(function Agent(world, type, cell) {
  ...
  _createClass(World, [{
    ...
    value: function getNeighbors(cell) {
      var x = cell.x,
          y = cell.y;
      var neighbors = [];
      console.log(this.state); // Get neighbors in all 4 directions
...
var _default = World;
exports.default = _default;
},{"./Cell":"src/Cell.js","./Agent":"src/Agent.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
function gameTick() {
  world.spawnAgent(); // Move current agents

  world.tick(); // Spawn new agent

  world.spawnAgent(); // setTimeout(gameTick, 1000);
}
